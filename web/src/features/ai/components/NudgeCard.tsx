...
const nudgeAction: Record<string, { route: string; label: string }> = {
  ...
  incomplete_reflection: { route: '/reflections', label: 'Write reflection' },
  idle_ideas: { route: '/ideas', label: 'Review ideas' },
  no_learning_progress: { route: '/skills', label: 'View skills' },
  missed_milestone: { route: '/projects', label: 'View projects' },
  goal_check_in: { route: '/direction', label: 'Check goals' },
}
